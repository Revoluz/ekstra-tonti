...
@section('content')
<h1 class="text-center">FORM INPUT BERITA</h1>
<div class="mt-5">
    <form  method="POST" enctype="multipart/form-data" action="/dashboard/berita">
        @csrf
        <div class="mb-3">
            <label for="judulBerita">Judul berita</label>
            <input type="text" class="form-control @error('judulBerita') is-invalid @enderror" id="judulBerita" name="judulBerita" value="{{old('judulBerita')}}" >
            @error('judulBerita')
        ...
        <div class="mb-3">
            ...
            @enderror
            <input id="isiBerita" type="hidden" name="isiBerita" required value="{{old('isiBerita')}}">
